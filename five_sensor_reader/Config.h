...
// タイミング設定
// ============================================================================
const unsigned long MEASUREMENT_INTERVAL = 40;  // 40ms = 25Hz
...
// ============================================================================
const float STEERING_KP = 0.1;               // 比例ゲイン（deg/mm）
const float STEERING_KI = 0.0;              // 積分ゲイン
...
// ============================================================================
const float ANGLE_KP = 1.0;                   // 比例ゲイン（deg/deg）
const float ANGLE_KI = 0.0;                   // 積分ゲイン（まず0で開始）
const float ANGLE_KD = 0.4;                   // 微分ゲイン
