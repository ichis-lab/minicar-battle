...
const float LD_BASE_OFFSET_MM = 1100.0; // 基準オフセット（直線時）
...
const uint16_t SERVO_CENTER = 1410;  // 中央位置（μs）
const uint16_t SERVO_MIN = 1110;     // 最小パルス幅（μs）= 最も右
const uint16_t SERVO_MAX = 1710;     // 最大パルス幅（μs）= 最も左
